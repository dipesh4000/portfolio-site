...
export function Footer() {
  return (
    <footer className="border-t border-white/8 py-12 px-6" style={{ backgroundColor: "#000000" }}>
          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((link) => (
              <a
                ...
                className="p-2.5 rounded-full border border-white/10 text-white/40 hover:text-white/80 hover:border-white/30 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/25"
